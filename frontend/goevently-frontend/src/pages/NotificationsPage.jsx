...
function getNotificationMessage(notification) {
  return (
    ...
    "You have a new notification from goEvently."
  );
}
    ...
    <AppLayout>
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          message="There are no notifications matching this filter yet."
        />
      ) : (
        <div className="space-y-5">
          {filteredNotifications.map((notification) => {
            ...
            const showBookingAction = isPaymentNotification(notification) && bookingId;
                ...
                <div className="grid gap-0 lg:grid-cols-[1fr_280px]">
                        ...
                        <div>
                          <div className="flex flex-wrap items-center gap-3">
                            ...
                            <Badge color={getStatusColor(meaningStatus)}>
                              {meaningStatus === "SUCCESS" ? "SUCCESS" : meaningStatus || "UNKNOWN"}
                            </Badge>
                  ...
                  <div className="border-t border-[#e6eaf2] bg-slate-50 p-6 lg:border-l lg:border-t-0">
                    <div className="space-y-4">
                      <MiniInfo label="Notification ID" value={notification.id} />
                      <MiniInfo
                        label="Type"
